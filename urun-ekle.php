...
if ($_POST) {
    ...
    $sorgu = $db->prepare('INSERT INTO urunler (AD, STOK, FİYAT, AÇIKLAMA) VALUES (:ad , :stok , :fiyat , :aciklama)');
    $sorgu->execute([
        'ad' => $ad,
        'stok' => $stok,
        'fiyat' => $fiyat,
    ...
    <div class="container pt-5">
        ...
        <form action="urun-ekle.php" method="post">
            <div class="mb-3">
                ...
                <input class="form-control " type="text" name="ad" autocomplete="off" value="" required />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control " type="text" name="aciklama" autocomplete="off" value="" required />
            </div>
